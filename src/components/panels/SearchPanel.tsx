...
export default function SearchPanel() {
  ...
  return (
    <div className="absolute left-1/2 top-14 z-30 w-96 -translate-x-1/2 rounded-xl border border-gray-200 bg-white shadow-2xl">
            ...
            <li key={m.nodeId}>
              ...
              >
                <div className="flex items-center gap-2">
                  ...
                  <span className="font-medium text-sm text-gray-800 truncate">{m.nodeName}</span>
                  <span className="ml-auto shrink-0 text-[10px] text-gray-400">{m.nodeKind}</span>
                </div>
                <p className="mt-0.5 truncate text-[11px] text-gray-500">{m.context}</p>
              </button>
            </li>
          ))}
        </ul>
